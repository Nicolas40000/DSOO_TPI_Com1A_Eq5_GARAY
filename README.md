...
- Nicolas Francisco Garay Lucena
...
## Video de Coloquio
Para visualizar la presentación en formato de video de este trabajo, se proporciona la siguiente dirección de enlace: **(https://youtu.be/)**.

## Base de datos
Previo a la ejecución de la aplicación debe crear la base de datos correspondiente. La misma se encuentra adjunta en la carpeta bajo el nombre: **DSOO_TPI_Com1A_G5_Garay.sql**.
