...
drop database if exists DSOO_C1A_G5_TPI_Garay;
create database DSOO_C1A_G5_TPI_Garay;
use DSOO_C1A_G5_TPI_Garay;
...
drop procedure if exists DSOO_C1A_G5_TPI_Garay.ingresoLogin//
...
delimiter // 
drop procedure if exists DSOO_C1A_G5_TPI_Garay.nuevoSocio //
...
delimiter // 
drop procedure if exists DSOO_C1A_G5_TPI_Garay.nuevoNoSocio //
...
-- Cambio el delimitador para poder crear el procedimiendo
delimiter //
drop procedure if exists DSOO_C1A_G5_TPI_Garay.obtenerDatosCliente //
...
-- Cambio el delimitador para poder crear el procedimiendo
delimiter //
drop procedure if exists DSOO_C1A_G5_TPI_Garay.registrarPago//
